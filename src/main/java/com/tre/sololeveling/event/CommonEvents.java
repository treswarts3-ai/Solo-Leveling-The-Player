...
public final class CommonEvents {
    ...
    public void death(LivingDeathEvent event) {
        ...
        if (victim instanceof ServerPlayer deadPlayer) {
            ProgressionChoiceHandler.onPlayerDeath(deadPlayer);
            PassiveHandler.breakStealth(deadPlayer);
            AbilityHandler.cancel(deadPlayer);
            ShadowHandler.dismissAll(deadPlayer);
        }
