...
| Abyssal Necropolis master dungeon | Implemented—needs gameplay testing | Twelve replaceable structure modules, explicit gameplay/presentation markers, guarded lifecycle, staged template placement, validation, encounters, safe return and owned-volume cleanup | In-game art pass and full gate-to-cleanup/death/reconnect/full-inventory/two-player walkthrough |
